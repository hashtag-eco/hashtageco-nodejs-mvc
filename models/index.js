...
db.Zwproductscrap.belongsTo(db.zproduct, {
  //연결테이블인 스크랩테이블은 상품, 멤버 테이블과 각각 일대일 관계입니다.
  foreignKey: "product_id",
});
...
db.Lcproductscrap.belongsTo(db.lcProduct, {
  //연결테이블인 스크랩테이블은 상품, 멤버 테이블과 각각 일대일 관계입니다.
  foreignKey: "product_id",
});
...
db.Uproductscrap.belongsTo(db.ucProduct, {
  //연결테이블인 스크랩테이블은 상품, 멤버 테이블과 각각 일대일 관계입니다.
  foreignKey: "product_id",
});
